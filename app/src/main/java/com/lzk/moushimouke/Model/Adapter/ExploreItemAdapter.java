...
public class ExploreItemAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ExploreItemAdapter(List<ExploreRecyclerItemBean> dataList, FragmentManager fragmentManager) {
